...
class IPCR(models.Model):
    ...
    stra_percentage = models.CharField(
        verbose_name=_("Strategic Function Adjectival Rating"), max_length=255, default="Poor"
    )

    stra_mfo_pap_1 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_1 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_2 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_2 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_3 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_3 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_4 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_4 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_5 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_5 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_6 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_6 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_7 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_7 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    stra_mfo_pap_8 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    stra_sucess_indicators_8 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_acad_mfo_pap_1 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_indicators_1 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_acad_mfo_pap_2 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_2 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_acad_mfo_pap_3 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_3 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_acad_mfo_pap_4 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_4 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_acad_mfo_pap_5 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_5 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_acad_mfo_pap_6 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_6 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_acad_mfo_pap_7 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_7 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_acad_mfo_pap_8 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_8 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_mfo_pap_9 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_9 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_acad_mfo_pap_10 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_acad_sucess_indicators_10 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    core_acad_q10 = models.DecimalField(verbose_name=_("Quality rating row 9"),max_digits=5, decimal_places=4, null=True)
    core_acad_e10 = models.DecimalField(verbose_name=_("Effeciency rating row 9"),max_digits=5, decimal_places=4, null=True)
    core_acad_t10 = models.DecimalField(verbose_name=_("Timelessness rating row 9"),max_digits=5, decimal_places=4, null=True)
    core_acad_a10 = models.DecimalField(verbose_name=_("Average rating row 9"),max_digits=5, decimal_places=4, null=True)

    core_acad_total = models.DecimalField(verbose_name=_("Average rating row 9"),max_digits=5, decimal_places=4, null=True)

    core_irp_pap_1 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_irp_indicators_1 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_irp_pap_2 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_irp_sucess_indicators_2 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_irp_pap_3 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_irp_sucess_indicators_3 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_irp_pap_4 =  models.TextField(verbose_name=_("dMFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_irp_sucess_indicators_4 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_irp_mfo_pap_5 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_irp_sucess_indicators_5 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_irp_mfo_pap_6 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_irp_sucess_indicators_6 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_tae_pap_1 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_tae_indicators_1 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_tae_pap_2 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True)
    core_tae_sucess_indicators_2 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_tae_pap_3 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_tae_sucess_indicators_3 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    mfo_tae_pap_4 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_tae_sucess_indicators_4 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_tae_mfo_pap_5 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_tae_sucess_indicators_5 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_tae_mfo_pap_6 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_tae_sucess_indicators_6 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    core_tae_mfo_pap_7 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    core_tae_sucess_indicators_7 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_1 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_1 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_2 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_2 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_3 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_3 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_4 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_4 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_5 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_5 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_6 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_6 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
    ...
    supp_mfo_pap_7 =  models.TextField(verbose_name=_("MFO/PAP row"), help_text=_("Not Required"), blank=True)
    supp_sucess_indicators_7 =  models.TextField(verbose_name=_("description"), help_text=_("Not Required"), blank=True) 
